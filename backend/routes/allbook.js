...
router.get('/allbook', async (req,res,next)=>{
    ...
    try{
        ...
        WHERE BOOK.book_id = BOOK_AUTHOR.BOOK_book_id 
        AND BOOK_AUTHOR.AUTHOR_author_id = AUTHOR.author_id 
        AND BOOK.book_id = BOOK_BOOK_TYPE.Book_book_id 
        AND BOOK_BOOK_TYPE.BOOK_TYPE_type_id = BOOK_TYPE.type_id
...
// SELECT book_id, book_name, pb_year, price, book_amount, book_image, description, popular, author_fname, author_lname
// FROM BOOK, BOOK_AUTHOR, AUTHOR
// WHERE BOOK.book_id = BOOK_AUTHOR.BOOK_book_id AND BOOK_AUTHOR.AUTHOR_author_id = AUTHOR.author_id