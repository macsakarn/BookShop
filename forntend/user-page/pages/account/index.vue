<template>
  <div class="container px-16 mx-auto">
    <main class="flex py-40">
      ...
      <section class="w-5/6">
        <p class="text-center text-2xl border-b-2 border-gray-400 pb-4">
          Account
        </p>
        ...
        <div class="flex mt-4">
          <div
            class="w-56 h-56 rounded-2xl border border-gray-400 overflow-hidden"
          >
            <img src="~/assets/USER/profile/01.png" alt="Profile" />
          </div>
          <div class="px-10">
            <p class="mb-6">
              Username : <span class="text-gray-600">test</span>
            </p>
            <div class="flex mb-6">
              <p class="mr-6">
